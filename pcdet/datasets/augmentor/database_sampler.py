...
class DataBaseSampler(object):
    ...
    def add_sampled_boxes_to_scene(self, data_dict, sampled_gt_boxes, total_valid_sampled_dict):
        ...
        for idx, info in enumerate(total_valid_sampled_dict):
            ...
            obj_points = np.fromfile(str(file_path), dtype=np.float32).reshape([-1, 3])
        ...
        '''
        frame_id_set = data_dict['frame_id']
        ...
        obj_points = painted_point_cloud(calib_path, img_path, obj_points, frame_id_set)
        '''
